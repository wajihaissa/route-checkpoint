...
function App() {
  ...
  const [selecterating, setSelecterating] = useState(0)
  return (
    <BrowserRoute>
    <div className="App">
      <NavBar setSearch={setSearch} selecterating={selecterating} setSelecterating={setSelecterating}  />
      <MovieList movies={movies} search={search}  selecterating={selecterating} />
      <Switch>
          <Route exact path='/'>
            <Home movies={movies} />
          </Route>
